...
class VerbsSettingsPanel (SettingsPanel):
	...
	def showSettingsDialog (self, settingsSizer):
		...
		self.displayConjugationModesList = settingsSizerHelper.addLabeledControl(self.displayConjugationModeText, wx.Choice, choices = displayConjugationModeChoices)
		...
		self.displayIrregularVerbsModesList = settingsSizerHelper.addLabeledControl(self.displayIrregularVerbsModeText, wx.Choice, choices = displayIrregularVerbsModeChoices)
