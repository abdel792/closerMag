...
class GlobalPlugin (globalPluginHandler.GlobalPlugin):
	...
	def createMenu (self):
		...
		# Translators: Item in the tools menu for the item allowing the display of the list of English irregular verbs.
		_("English ir&regular verbs..."),
		# Translators: The tooltyp text for the item allowing the display of the list of English irregular verbs.
	...
	# Translators: Message presented in input help mode.
	script_displayIrregularVerbs.__doc__ = _("Displays the list of English irregular verbs with their preterite, past participle, as well as their French translations.")
	...
	def onIrregularVerbsDialog(self, evt = None):
		...
		addition = ("Infinitif", "Prétérit", "Passé composé", "Traduction en français")
		i = 0
		lst = []
		for item in verbs:
	...
	def conjugate (self):
		...
		if config.conf["verbs"]["displayConjugationMode"] == "HTMLMessage":
			...
			infinitif = f"{group.replace(' Groupe: ---', '')} Le verbe {self.verb} est un auxiliaire." if "---" in group else f"{group}."
